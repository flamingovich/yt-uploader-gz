...
CREATE TABLE IF NOT EXISTS channels (
  ...
  schedule_window_start_mins INTEGER NOT NULL DEFAULT 540,
  schedule_window_end_mins INTEGER NOT NULL DEFAULT 1439,
  ...
  stream_preview_layout_json TEXT,
  stream_preview_layout_white_json TEXT,
  stream_preview_bumper_layout_json TEXT,
...
CREATE TABLE IF NOT EXISTS streamers (
  ...
  stream_type TEXT NOT NULL DEFAULT 'casino',
  stream_mode TEXT NOT NULL DEFAULT 'random',
  single_segment_path TEXT,
  bumper_video_path TEXT,
  bumper_overlay_path TEXT,
  /** NULL = авто (до 3 мин если ролик короче); 0 = один проигрыв; >0 = зациклить до N сек. */
  bumper_pad_target_sec INTEGER,
  /** 1 = начальная сцена без звука в эфире. */
  bumper_mute_audio INTEGER NOT NULL DEFAULT 0 CHECK (bumper_mute_audio IN (0, 1)),
  stream_music_folder_path TEXT,
  stream_music_volume INTEGER NOT NULL DEFAULT 100,
  bumper_music_folder_path TEXT,
  bumper_music_volume INTEGER NOT NULL DEFAULT 100,
  video_bitrate_kbps INTEGER NOT NULL DEFAULT 6000,
  video_bitrate_mode TEXT NOT NULL DEFAULT 'cbr',
  /** Ширина выходного кадра: 720, 900 или 1080 (в паре с высотой 1280 / 1600 / 1920). */
  stream_output_width INTEGER NOT NULL DEFAULT 1080,
  stream_output_height INTEGER NOT NULL DEFAULT 1920,
  /** Кадров в секунду на выходе: 24, 30, 50 или 60. */
  stream_video_fps INTEGER NOT NULL DEFAULT 30,
